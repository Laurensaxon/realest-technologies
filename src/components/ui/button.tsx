  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transform active:scale-95",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-brand-green to-brand-orange text-white font-semibold hover:shadow-glow hover:scale-105 hover:from-brand-green-light hover:to-brand-orange-light",
        glass: "bg-background/10 backdrop-blur-sm border border-foreground/20 text-foreground hover:bg-background/20 hover:border-foreground/30 hover:shadow-soft",
        premium: "bg-gradient-to-r from-brand-blue to-brand-green text-white font-semibold hover:shadow-premium hover:scale-105 hover:from-brand-blue-light hover:to-brand-green-light",
      },
      size: {
