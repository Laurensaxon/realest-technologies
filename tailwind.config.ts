		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					...
					'50%': {
						boxShadow: '0 0 40px hsl(var(--brand-green) / 0.6), 0 0 60px hsl(var(--brand-green) / 0.4)'
					}
				},
				'glow-orange': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--brand-orange) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--brand-orange) / 0.6), 0 0 60px hsl(var(--brand-orange) / 0.4)'
					}
				},
				'slide-up': {
					'0%': {
